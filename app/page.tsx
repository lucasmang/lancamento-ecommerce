        ...
        <div className="max-w-4xl w-full flex flex-col items-center gap-10">
          ...
          <div className="max-w-2xl text-center">
            <p className="text-lg md:text-xl text-muted-foreground leading-relaxed text-pretty">
              Estamos preparando uma experiência de compras única para você. 
              Nossa loja online está quase pronta com produtos incríveis e 
              ofertas exclusivas. Fique por dentro das novidades!
            </p>
          </div>
